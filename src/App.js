				...
				<Panel id='main' style={{ zIndex: 1 }}>
					...
					<div style={{ zIndex: 3 }}>
						...
						<div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '80vw', textAlign: 'center', zIndex: 3 }}>
							...
							{
								this.state.screen &&
								<Title level={2} weight='semibold' style={{ position: 'absolute',top: '100%', left: '50%', transform: 'translate(-50%, 20%)', width: '80vw', textAlign: 'center', marginTop: '20vh', color: 'white' }}>
